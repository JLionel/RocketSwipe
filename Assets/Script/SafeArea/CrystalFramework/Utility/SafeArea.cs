...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        /// <summary>
        /// Normalised safe areas for Honor 10 using landscape right. Absolute values and aspect ratio same as above.
        /// </summary>
        Rect[] NSA_Honor_10 = new Rect[]
        {
            new Rect (0f, 0f, 1f, 2190f / 2280f),  // Portrait
            new Rect (0f, 0f, 2190f / 2280f, 1f)  // Landscape
        };
        #endregion
